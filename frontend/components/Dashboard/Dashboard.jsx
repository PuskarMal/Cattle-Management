...
const Dashboard = () => {
  ...
  return (
    <main className="w-full p-6 md:p-10 bg-gray-100">

      {/* ================= HERO SECTION ================= */}
      <div className="relative w-full min-h-[75vh] rounded-3xl overflow-hidden mb-14">
        ...
        {/* Content */}
        <div
          className={`relative z-10 mx-auto p-10 text-white
          backdrop-blur-xl bg-white/10 border border-white/20
          rounded-3xl shadow-2xl transition-all duration-1000
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-semibold mb-3
            ...
            animate-[shimmer_4s_linear_infinite] pb-22">
            {t("head")}
          </h1>

          {/* Description */}
          <p className="text-amber-100/90 leading-relaxed max-w-3xl">
            {t("longtext")}
          </p>
          ...
          <div className="flex flex-wrap gap-2 mt-5 text-xs">
            {[
              ...
              <span
                ...
                backdrop-blur-md animate-[float_4s_ease-in-out_infinite]"
